...
type AboutUsDocumentDataSlicesSlice = TitleSlice;
...
export interface FeaturesSliceDefaultItem {
   ...
   */
  icon: prismic.SelectField<"calendar" | "clover" | "hourglass">;
...
export interface HeroSliceDefaultPrimary {
   ...
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: بیشتر از ده کاراکتر باشه
 ...
 * Primary content in *Hero → Primary*
 */
export interface HeroSliceAnotherModelPrimary {
  /**
   * Heading field in *Hero → Primary*
   *
   * - **Field Type**: Rich Text
...
/**
 * Another model variation for Hero Slice
 *
 * - **API ID**: `anotherModel`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroSliceAnotherModel = prismic.SharedSliceVariation<
  "anotherModel",
  Simplify<HeroSliceAnotherModelPrimary>,
  never
>;
 ...
 */
type HeroSliceVariation = HeroSliceDefault | HeroSliceAnotherModel;
...
export interface TitleSliceDefaultItem {
  /**
   * Item field in *Title → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: title.items[].item
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceAnotherModelPrimary,
      HeroSliceVariation,
      HeroSliceDefault,
      HeroSliceAnotherModel,
      TitleSlice,
